...
private:
    void scanCallback(const sensor_msgs::msg::LaserScan::SharedPtr scan)
    {
        ...
        //Create a copy of the original scan data:
        auto subset_scan_1 = std::make_shared<sensor_msgs::msg::LaserScan>(*scan);
        //scan->ranges is a list of distance measurements, with each entry corresponding to an angle in the scan.
        //start_index_1 and end_index_1 are the positions in this list that correspond to 0° and 30°, respectively.
        //The line creates a new list of distance measurements from start_index_1 to end_index_1 and assigns it to subset_scan_1->ranges
